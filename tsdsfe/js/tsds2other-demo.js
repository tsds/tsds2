// Index and Size are odd.  Size seems redundant. Index refers to index in node.
// For ASCII, it would seem index of parameter would also be needed.
// Who would ever use Component.{I,J,K}
// Todd: Need something that returns SPASE given SPASE ID
// Need to add fill value and rendering hint
// Need delimiter
// Denton data set challenge
var fs     = require('fs');
var xml2js = require('xml2js')
var parser = new xml2js.Parser();

var body = fs.readFileSync('tsds2other-demo.xml')
