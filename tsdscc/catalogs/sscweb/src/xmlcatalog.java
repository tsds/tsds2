	...
	public static void main(String[] args) {
		...
		try{
			...
			System.out.print("\t<documentation xlink:href='http://sscweb.gsfc.nasa.gov/WebServices/' xlink:title='Catalog derived using the SSCWeb Service'/>\n");
	  		System.out.print("\t\t<documentation xlink:href='http://github.com/tsds/tsds2/tsdscc/catalogs/sscweb/' xlink:title='Catalog generation software'/>\n");
