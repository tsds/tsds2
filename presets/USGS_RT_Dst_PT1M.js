...
Presets[id].URLTemplate = "http://magweb.cr.usgs.gov/data/indices/beta/Dst_minute/usgs$Y$m$ddst4.min";

Presets[id].CatalogDescription = "Catalog derived from inspection of"
Presets[id].CatalogDescriptionURL = "http://magweb.cr.usgs.gov/data/indices/beta/Dst_minute/";
...
Presets[id].DatasetDescription = "Real-time Dst estimate from USGS; 1-minute cadence."; 
